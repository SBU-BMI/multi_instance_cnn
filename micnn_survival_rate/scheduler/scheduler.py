...
class Scheduler:
    ...
    def _load_arguments(self):
        ...
        self.validation_ratio = self.config['validation_ratio']
    ...
    def train_mil(self):
        ...
        fg_mask = data_preprocess.FG_Mask(self.wsi_root, self.mask_root, self.label_file, self.scales[0], self.patch_size, self.tile_size, self.max_num_patches)
